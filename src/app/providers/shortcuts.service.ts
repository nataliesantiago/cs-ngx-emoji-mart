...
import { ShortCut } from '../../schemas/interfaces';
...
export class ShortcutsService {
     ...
     * @returns Promise
     */
    crearShortcut(shortcut: ShortCut): Promise<any> {
        return new Promise((resolve, reject) => {
            this.ajax.post('chat/shortcuts/crear', shortcut).subscribe(d => {
                if (d.success) {
                    resolve(d.id);
                } else {
                    reject(d.error);
    ...
    /**
     * @description Obtiene los shortcuts del usuario actual
     * @param  {ShortCut} shortcut
     * @returns Promise
     */
    getShortcutsUsuario(): Promise<any> {
        return new Promise((resolve, reject) => {
